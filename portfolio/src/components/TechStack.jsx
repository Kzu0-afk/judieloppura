                ...
                <div className="flex items-center gap-4 mb-4">
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-semibold text-accent-400 min-w-[3rem] text-right">{tech.level}%</span>
                    </div>
                  </div>
                </div>

                <div className="absolute top-0 right-0 w-16 h-16 bg-gradient-to-br from-primary-500/10 to-transparent rounded-bl-3xl rounded-tr-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
              </div>
            ))}
          </div>
        </AnimatedSection>
