      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            <AnimatedSection
              ...
              delay={index * 150}
            >
              <div className="group bg-zinc-800 border border-zinc-700 rounded-2xl overflow-hidden hover:border-primary-500/50 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-primary-500/10 glow-hover-area hover:glow-strong">
        ...
        <AnimatedSection animation="fade-in-up" delay={500} className="mt-12 text-center">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-3 px-8 py-4 bg-zinc-800 hover:bg-zinc-700 text-zinc-100 rounded-lg font-medium transition-all duration-300 hover:scale-105 border border-zinc-700 hover:border-primary-500/50 glow-hover-area hover:glow"
          >
