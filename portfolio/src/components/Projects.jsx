  ...
  const projects = [
    {
      ...
      description:
        "A decentralized note-taking application using basic blockchain principles. Django-powered backend with React frontend implementing blockchain technology for secure, tamper-proof note storage.",
    ...
    },
    {
      ...
      title: "ledgerly-web",
      description:
        "A web-based ledger application for tracking personal transactions. Built with Python Django backend and Tailwind CSS for a modern, responsive interface.",
    ...
    },
    {
      ...
      title: "farmIT",
      description:
        "A platform connecting farmers and sellers for local product display and purchases. Django-powered marketplace enabling direct farmer-to-consumer transactions with product management and order processing.",
    ...
    <section id="projects" className="py-24 px-6 lg:px-8 bg-zinc-900 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <AnimatedSection animation="fade-in-down" className="text-center mb-16">
          ...
          <div className="w-20 h-1 bg-gradient-to-r from-primary-500 via-accent-500 to-accent-600 mx-auto rounded-full mb-4" />
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            <AnimatedSection key={project.id} animation="scale-in" delay={index * 150}>
              <div className="group bg-zinc-800/50 backdrop-blur-sm border border-zinc-700 rounded-3xl overflow-hidden hover:border-primary-500/50 transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl hover:shadow-primary-500/20">
                <div className={`relative h-48 bg-gradient-to-br ${project.gradient} p-6 flex items-center justify-center overflow-hidden`}>
                  ...
                  <div className="absolute inset-0 opacity-10">
                    <div className="absolute inset-0 bg-[linear-gradient(to_right,#ffffff_1px,transparent_1px),linear-gradient(to_bottom,#ffffff_1px,transparent_1px)] bg-[size:2rem_2rem] group-hover:animate-pulse-slow" />
                  </div>
                ...
                <div className="p-7">
                  <p className="text-zinc-300 mb-6 leading-relaxed min-h-[80px] text-base">{project.description}</p>
