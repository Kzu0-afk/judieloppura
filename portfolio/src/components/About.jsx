              ...
              <div className="flex items-start gap-4 group glow-hover-area p-6 rounded-xl transition-all duration-500 hover:bg-zinc-900/30 hover:scale-[1.02] cursor-default">
                ...
                <div>
                  ...
                  <p className="text-zinc-400 leading-relaxed">
                    Architecting end-to-end solutions from database design to polished UIs. Specialized in building robust,
                    production-ready features that balance performance with user experience.
                  </p>
                </div>
              </div>
            </AnimatedSection>
            ...
            <AnimatedSection animation="fade-in-left" delay={300}>
              <div className="flex items-start gap-4 group glow-hover-area p-6 rounded-xl transition-all duration-500 hover:bg-zinc-900/30 hover:scale-[1.02] cursor-default">
                ...
                <div>
                  ...
                  <p className="text-zinc-400 leading-relaxed">
                    Integrating industry-standard security from day one: JWT auth, rate limiting, encrypted data transmission,
                    and DDoS protection across all projects.
                  </p>
                </div>
              </div>
            </AnimatedSection>
