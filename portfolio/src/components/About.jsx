        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <AnimatedSection animation="fade-in-left" delay={100}>
              <div className="flex items-start gap-4 group glow-hover-area p-6 rounded-xl transition-all duration-300">
                <div className="flex-shrink-0 w-12 h-12 rounded-lg bg-primary-500/10 border border-primary-500/20 flex items-center justify-center group-hover:bg-primary-500/20 group-hover:glow transition-all">
          ...
          <div className="space-y-6">
            ...
            <AnimatedSection animation="fade-in-right" delay={200}>
              <div className="p-8 bg-zinc-900 border border-zinc-800 rounded-2xl glow-hover-area hover:border-primary-500/30 transition-all duration-300">
