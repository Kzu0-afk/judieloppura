  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center pt-20 px-6 lg:px-8 overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-br from-zinc-950 via-zinc-900 to-zinc-950">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-primary-600/8 via-transparent to-transparent" />
      </div>
      ...
      <div className="absolute top-1/2 right-1/3 w-40 h-40 bg-primary-400/10 rounded-full blur-2xl animate-float opacity-50" />
      <div className="absolute bottom-1/3 left-1/3 w-56 h-56 bg-accent-400/10 rounded-full blur-3xl animate-float-delayed opacity-40" />
